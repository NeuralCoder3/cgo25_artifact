...
{
  __asm volatile("# LLVM-MCA-BEGIN sort3_mimicry_mu":::"memory");
	asm volatile(
		"mov (%0), %%eax                        \n"
		"mov 4(%0), %%edx                       \n"
		"cmp %%eax, %%edx                       \n"
...
{
  __asm volatile("# LLVM-MCA-BEGIN sort3_mimicry_ms":::"memory");
	asm volatile(
		"mov (%0), %%eax \n"
		"mov 4(%0), %%edx \n"
...
{
  __asm volatile("# LLVM-MCA-BEGIN sort3_mimicry_mv":::"memory");
	asm volatile(
		"vmovdqa mask3, %%xmm1                 \n"
...
{
  __asm volatile("# LLVM-MCA-BEGIN sort3_mimicry_std":::"memory");
...
{
  __asm volatile("# LLVM-MCA-BEGIN sort4_mimicry_mu":::"memory");
	asm volatile(
		"mov (%0), %%eax                        \n"
		"mov 4(%0), %%edx                       \n"
		"cmp %%eax, %%edx                       \n"
...
{
  __asm volatile("# LLVM-MCA-BEGIN sort4_mimicry_ms":::"memory");
	asm volatile(
		"mov (%0), %%eax                        \n"
		"mov 4(%0), %%edx                       \n"
...
{
  __asm volatile("# LLVM-MCA-BEGIN sort4_mimicry_mv":::"memory");
	asm volatile(
		"vmovdqu (%0), %%xmm1            \n"
