...
tseq=$(python -u watch.py sequential/domain.pddl sequential/problem.pddl seq_plan.txt 77 30)
handle_timeout $tseq "Sequential"

tseq=$(python -u watch.py conditional_parallel/domain.pddl conditional_parallel/problem.pddl parallel.txt 77 900)
...
tseq=$(python -u watch.py grounded/domain.pddl grounded/problem.pddl grounded.txt 77 900)
handle_timeout $tseq "Parallel"
